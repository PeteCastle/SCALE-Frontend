...
const SecondSection = () => {
  return (
    <>
      <section className='w-full h-full max-h-screen  dark:bg-gray-900'>
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          ...
          <div className="grid justify-center gap-8 mb-6 lg:mb-16 md:grid-cols-2 md:grid-rows-auto">
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <span className="text-gray-500 dark:text-gray-400">
                  Project Leader, Backend AI, Cloud, Arduino Developer
                </span>
